...
static const char revision[] = "$Id: qstail.c,v 1.11 2012-03-30 19:05:36 pbuchbinder Exp $";
...
static void usage(char *cmd, int man) {
  ...
  if(man) {
    printf(".SH SEE ALSO\n");
    printf("qsexec(1), qsfilter2(1), qsgeo(1), qsgrep(1), qslog(1), qslogger(1), qspng(1), qsrotate(1), qssign(1)\n");
    printf(".SH AUTHOR\n");
