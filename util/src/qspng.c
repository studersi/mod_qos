...
static const char revision[] = "$Id: qspng.c,v 1.15 2012-04-05 07:52:57 pbuchbinder Exp $";
...
static void usage(char *cmd, int man) {
  ...
  if(man) {
    printf(".SH SEE ALSO\n");
    printf("qsexec(1), qsfilter2(1), qsgeo(1), qsgrep(1), qslogger(1), qslog(1), qsrotate(1), qssign(1), qstail(1)\n");
    printf(".SH AUTHOR\n");
